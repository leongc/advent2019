...
function run2(original, inputValue) {
  var program = original.slice();
  let pc = 0;
  while (true) {
    let opcode = program[pc] % 100;
...
// eq 8 pos
console.assert(run2([3,9,8,9,10,9,4,9,99,-1,8], 8)[9] === 1);
console.assert(run2([3,9,8,9,10,9,4,9,99,-1,8], 0)[9] === 0);
// lt 8 pos
console.assert(run2([3,9,7,9,10,9,4,9,99,-1,8], 8)[9] === 0);
console.assert(run2([3,9,7,9,10,9,4,9,99,-1,8], 7)[9] === 1);
// eq 8 imm
console.assert(run2([3,3,1108,-1,8,3,4,3,99], 8)[3] === 1);
console.assert(run2([3,3,1108,-1,8,3,4,3,99], 7)[3] === 0);
// lt 8 imm
console.assert(run2([3,3,1107,-1,8,3,4,3,99], 8)[3] === 0);
console.assert(run2([3,3,1107,-1,8,3,4,3,99], 7)[3] === 1);
// zero?
console.assert(run2([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9], 0)[13] === 0);
console.assert(run2([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9], 88)[13] === 1);
console.assert(run2([3,3,1105,-1,9,1101,0,0,12,4,12,99,1], 0)[12] === 0);
console.assert(run2([3,3,1105,-1,9,1101,0,0,12,4,12,99,1], 88)[12] === 1);
// 8 <=> --> 999 / 1000 / 1001
console.assert(run2([3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,
1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,
999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99], 7)[20] === 0);
console.assert(run2([3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,
1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,
999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99], 8)[20] === 1000);
console.assert(run2([3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,
1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,
999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99], 9)[20] === 1001);

console.log(run2(day05input, 5));
